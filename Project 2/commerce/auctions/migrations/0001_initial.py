# Generated by Django 4.2.4 on 2023-08-26 05:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bid', models.DecimalField(decimal_places=2, max_digits=6, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ...
                ('winner', models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, related_name='won_listings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
